...
import type { FormRef, LocalStorageFormData } from "../../types/formTypes";
  ...
  useEffect(() => {
    if (hasLoaded) {
      const localStorageData: LocalStorageFormData = {
        ...
        situationDescriptions: hasData(formData.situationDescriptions as unknown as Record<string, unknown>) ? formData.situationDescriptions : null,
      };
